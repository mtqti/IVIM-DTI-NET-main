...
updated and changed to accomodate to 7T relaxation times and 7T-friendly parameter bounds in January 2026 by Tahir Qureshi
muhammad1.qureshi@st.ovgu.de
...
def plot_dependency_figs(D, fint, Dint, f, Dp, params, method):
    ...
    plt.plot(fint, D, color='lightgray', linestyle='', marker='.', markersize=2)
    plt.plot(params[4], params[0], 'b.', markersize=1)
    plt.xlabel('Fint', fontsize=20)
    plt.ylabel('Dpar', fontsize=20)
